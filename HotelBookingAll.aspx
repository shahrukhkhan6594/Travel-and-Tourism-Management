<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="HotelBookingAll.aspx.cs" Inherits="HotelBookingAll" %>
                ...
                <table style="width: 97%; height: auto; margin-left: 13px; background-color: black; border-radius: 20px">
                    <tr>
                        ...
                        <td style="height: 94px; font-size: medium; text-align: center;" colspan="6">
                            <br />
                            <asp:Label ID="titleLabel" runat="server">View Hotel Booking</asp:Label>
                        </td>
                    ...
                    <tr style="text-align:center;">
                        <td colspan="9" style="text-align:center;">
                            <asp:GridView ID="GridViewHotelBooking" runat="server" AutoGenerateColumns="False" BorderColor="White" BorderStyle="Ridge" CellSpacing="2" EnableTheming="True" Height="223px" PageSize="3" TabIndex="3" UseAccessibleHeader="False" Width="863px" AllowPaging="True" OnPageIndexChanging="GridViewHotelBooking_PageIndexChanging" >
