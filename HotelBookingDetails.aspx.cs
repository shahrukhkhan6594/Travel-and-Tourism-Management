...
public partial class Default3 : System.Web.UI.Page
{
    ...
    {
        da = new SqlDataAdapter("insert into HotelBookingDetails(UserId,H_Id,Room_Category,NoOfPerson,CheckInDate,CheckOutDate,Amount,Description)values('" + userid + "','" + Label1.Text + "','" + Label3.Text + "'," + personLabel.Text + ",'" + checkinLabel.Text + "','" + checkoutLabel.Text + "'," + AmoutLabel.Text + ",'" + DesLabel2.Text + "')", con);
        dt = new DataTable();
        da.Fill(dt);
